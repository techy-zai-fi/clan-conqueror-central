...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Clash of Clans 2025 - IIM Bodh Gaya',
        short_name: 'Clash of Clans',
        description: 'Follow the action at IIM Bodh Gaya\'s premier intra-college sports championship',
        theme_color: '#1a1f2e',
